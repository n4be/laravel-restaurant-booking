<x-admin-app-layout>
    <x-slot name="pageTitle">
        <header class="d-flex border-bottom pb-3 align-items-center">
            <h2 class="m-0 fs-4">{{ $restaurant->name }}のメニューを登録する</h2>
        </header>
    </x-slot>


    <div class="container">
        <form method="POST" action="{{ route('restaurant.menu.store', $restaurant) }}">
            @csrf
            <div>
                <div class="mt-4">
                    ...
                    <input id="name" type="text"
                        ...
                        name="name" value="{{ old('name') }}" required placeholder="メニュー名">
                </div>
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <input id="price" type="text"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        name="price" value="{{ old('price') }}" required placeholder="料金">
                </div>
